...
extern class IAP *iap;
extern class RS485 *rs485;
extern class SelfTest *selftest;
...
public:
	...
	//void ParseMsg(CMsg obj[], int &msg_cntr, char buffer[], std::string &incomplete_msg);
	void ParseMsg(CMsg obj[], int &msg_cntr, char buffer[], std::string &incomplete_msg	, DWORD dwbytesread);
protected:
